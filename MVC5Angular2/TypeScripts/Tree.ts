module Enco {
    export class TreeView {
		...
		public collapseClick = function (elem) { }
		public oncollapse = function (elem) { }

		public Load(params: any, config?: any) {
            var SELF = this;
        ...
        private RenderPage(list: any, template: string, container: string) {
            var me = this,
                pageHTML = '';
        ...
        static BindHTML(templateId: string, obj: any, level: number) {
